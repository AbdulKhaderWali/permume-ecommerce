    ...
    <div>
        ...
        <div className="container mx-auto text-center px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 bg-gray-900 rounded-lg shadow-lg">
              ...
              <Button href="/shop?category=men" variant="secondary">Shop Now &rarr;</Button>
            </div>
            <div className="p-8 bg-gray-900 rounded-lg shadow-lg">
              ...
              <Button href="/shop?category=women" variant="secondary">Shop Now &rarr;</Button>
            </div>
            <div className="p-8 bg-gray-900 rounded-lg shadow-lg">
              ...
              <Button href="/shop?category=unisex" variant="secondary">Shop Now &rarr;</Button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-900 py-20 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <Button href="/gifting" variant="primary">
            Shop Gifts
          </Button>
        </div>
      </div>
        ...
        <div className="container mx-auto text-center px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 bg-gray-900 rounded-lg shadow-lg text-left">
              ...
              <Button href="/journal/language-of-scent" variant="secondary">Read More &rarr;</Button>
            </div>
            <div className="p-8 bg-gray-900 rounded-lg shadow-lg text-left">
              ...
              <Button href="/journal/guide-to-layering" variant="secondary">Read More &rarr;</Button>
            </div>
            <div className="p-8 bg-gray-900 rounded-lg shadow-lg text-left">
              ...
              <Button href="/journal/new-arrivals" variant="secondary">Read More &rarr;</Button>
            </div>
          </div>
        </div>
      </div>
